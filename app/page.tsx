      ...
      <div className="p-0 m-0">
        <div
          className={`h-screen w-full relative overflow-hidden flex items-center justify-center transition-all duration-500 ${
            scaled
              ? "scale-93 sm:scale-97 rounded-lg"
        ...
        <div className="min-h-full sm:min-h-screen w-full px-6 sm:px-40 pt-20 sm:pt-0 sm:py-20 flex flex-col sm:flex-row gap-15 justify-center items-center">
          <div
            className="font-[Inter] text-justify sm:text-start text-lg sm:text-xl leading-[1.8] sm:leading-[2.5]"
            style={{ wordSpacing: "4px" }}
          >
            The AI Student Chapter is dedicated to fostering innovation,
            learning, and collaboration in the field of Artificial Intelligence.
            Aligned with{" "}
            <span className="text-3xl sm:text-4xl font-bold font-[Merriweather]">
              AICTE
            </span>
            &apos;s (All India Council for Technical Education) vision, we aim
            to integrate AI into education through workshops, research
            initiatives, industry partnerships, and student-driven projects. Our
            mission is to equip students with the knowledge and skills needed to
            lead the AI revolution, ensuring ethical and impactful advancements
            in technology.
            <a href="/AI Student Chapter.pdf" download="AI Student Chapter.pdf">
        ...
        <div className="min-h-full w-full px-6 sm:px-14 pb-20 flex flex-col gap-10 mt-20 sm:mt-0">
          <span className="font-[Merriweather] font-semibold text-3xl sm:text-5xl">
            Questions Related To Our Club
          </span>
          <Accordion></Accordion>
        </div>
      </div>
